...
using ORBIT.ComLink.Client.Audio.Managers;
using ORBIT.ComLink.Client.Network.DCS;
using ORBIT.ComLink.Client.Properties;
using ORBIT.ComLink.Client.Settings.Favourites;
using ORBIT.ComLink.Client.Singletons;
using ORBIT.ComLink.Client.UI.ClientWindow.ClientList;
using ORBIT.ComLink.Client.UI.ClientWindow.Favourites;
using ORBIT.ComLink.Client.UI.ClientWindow.RadioOverlayWindow;
...
using AwaRadioOverlayWindow =
    ORBIT.ComLink.Client.UI.ClientWindow.AwacsRadioOverlayWindow.AwaRadioOverlayWindow;
