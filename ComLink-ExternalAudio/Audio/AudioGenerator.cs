...
using ORBIT.ComLink.ExternalAudioClient.Client;
...
namespace ORBIT.ComLink.ExternalAudioClient.Audio
{
    public class AudioGenerator
    {
        ...
        public List<byte[]> GetOpusBytes()
        {
            ...
            var encoder = OpusEncoder.Create(INPUT_SAMPLE_RATE, 1,  ORBIT.ComLink.Common.Audio.Opus.Application.Voip);
